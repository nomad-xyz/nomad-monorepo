...
} from '@nomad-xyz/contracts/dist/core';
...
export async function dispatchMessage(
  ...
  await home.dispatch(
    destinationDomain,
    nomad.ethersAddressToBytes32(recipientAddress),
...
export async function formatNomadMessage(
  replica: TestReplica,
  ...
  // Create Nomad message that is sent from the governor domain and governor
...
export async function formatCall(
  ...
  return {
    to: nomad.ethersAddressToBytes32(destinationContract.address),
