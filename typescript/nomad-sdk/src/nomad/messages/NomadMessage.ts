...
import { core } from '@nomad-xyz/contracts';
...
export class NomadMessage {
  ...
  readonly context: NomadContext;
  protected cache: EventCache;

  constructor(context: NomadContext, dispatch: AnnotatedDispatch) {
  ...
  static singleFromReceipt(
    ...
    const messages: NomadMessage[] = NomadMessage.fromReceipt(
      context,
      nameOrDomain,
      receipt,
    );
  ...
  static async fromTransactionHash(
    ...
    return NomadMessage.fromReceipt(context, nameOrDomain, receipt);
  }
