...
import { bridge } from '@nomad-xyz/contracts';
import { BridgeContracts, NomadContext } from '..';
import { ResolvedTokenInfo, TokenIdentifier } from '../tokens';
import { NomadMessage } from './NomadMessage';
import { AnnotatedDispatch } from '../events/nomadEvents';
 ...
 * functionality.
 */
class BridgeMessage extends NomadMessage {
  ...
  static fromReceipt(
    ...
    const nomadMessages: NomadMessage[] = NomadMessage.fromReceipt(
      context,
      nameOrDomain,
      receipt,
    );
