...
import { BridgeRouter, ETHHelper } from '@nomad-xyz/contract-interfaces/dist/bridge';
...
export class BridgeContracts extends Contracts {
  ...
  get bridgeRouter(): BridgeRouter {
    ...
    return bridge.BridgeRouter__factory.connect(
      this._bridgeRouter,
  ...
  get ethHelper(): ETHHelper | undefined {
    ...
    return bridge.ETHHelper__factory.connect(
      this._ethHelper,
      this.providerOrSigner,
    );
  }
  ...
  static fromObject(
    ...
    return new BridgeContracts(id, router, ethHelper, providerOrSigner);
  }
