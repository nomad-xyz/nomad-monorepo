...
interface TestTokenRegistryInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "migrationTarget",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "mustHaveToken",
    values: [BytesLike]
  ): string;
...
export class TestTokenRegistry extends BaseContract {
  ...
  interface: TestTokenRegistryInterface;
  ...
  migrationTarget(_oldRepr: string, overrides?: CallOverrides): Promise<string>;
