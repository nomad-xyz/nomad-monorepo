...
async function improperUpdateHome() {
  let success = false;
  ...
  try {
    ...
    console.log(`Submitted improper update to home`);
...
async function improperUpdateReplica() {
    let success = false;
    ...
    try {
      ...
      console.log(`Submitted improper update to replica`);
  ...
  (async () => {
    ...
    await improperUpdateHome();
    await improperUpdateReplica();
  })()