...
mod replica_mod {
    ...
    impl<'a, M: ethers::providers::Middleware> Replica<M> {
        ...
        #[doc = "Calls the contract's `MAXIMUM_GAS` (0x44c6d57a) function"]
        pub fn maximum_gas(
            &self,
        ) -> ethers::contract::builders::ContractCall<M, ethers::core::types::U256> {
            self.0
                .method_hash([68, 198, 213, 122], ())
    ...
    #[doc = "Container type for all input parameters for the `MAXIMUM_GAS`function with signature `MAXIMUM_GAS()` and selector `[68, 198, 213, 122]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[ethcall(name = "MAXIMUM_GAS", abi = "MAXIMUM_GAS()")]
    pub struct MaximumGasCall;
    ...
    impl ethers::core::abi::AbiDecode for ReplicaCalls {
        fn decode(data: impl AsRef<[u8]>) -> Result<Self, ethers::core::abi::AbiError> {
            if let Ok(decoded) =
                <MaximumGasCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(ReplicaCalls::MaximumGas(decoded));
            }
            if let Ok(decoded) =
    ...
    impl ethers::core::abi::AbiEncode for ReplicaCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ReplicaCalls::MaximumGas(element) => element.encode(),
    ...
    impl ::std::fmt::Display for ReplicaCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ReplicaCalls::MaximumGas(element) => element.fmt(f),
    ...
    impl ::std::convert::From<MaximumGasCall> for ReplicaCalls {
        fn from(var: MaximumGasCall) -> Self {
            ReplicaCalls::MaximumGas(var)
        }
    }
